...
class vLLMRollout(BaseRollout):
    def __init__(self, model_path: str, config: DictConfig, tokenizer, model_hf_config, **kwargs):
        ...
        # 一般不需要设置 max_model_len
        # 会自动根据 prompt_length 和 response_length 计算
        ...
        # 注意 roll 多次的实现 是 在 ray_trainer 中 repeat
        # 所以这里是固定设置成 n = 1 的
    ...
    def generate_sequences(self, prompts: DataProto, **kwargs) -> DataProto:
        ...
        # 收到 repeat 之后的 dataproto，
        # 先从中取出 input_ids，也就是所有的 prompt
        ...
        # 每个 gpu 上实际的 batch 大小，是指分到 seq 的数量
        # 遵循这个关系 batch_size = gen_batch_size * n_roll / n_gpus
        ...
        with self.update_sampling_params(**kwargs):
            outputs = self.inference_engine.generate(
                ...
                use_tqdm=False,  # Disable vLLM built-in progress bar
            )
